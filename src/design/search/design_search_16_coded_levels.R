...
# Original source file: Design_16_2.R
# Purpose: Search for a 16-point space-filling design via permutation-based centered L2-discrepancy minimization (coded levels).
