...
# Original source file: Design_32_1.R
# Purpose: Search for a 32-point space-filling design via permutation-based centered L2-discrepancy minimization (raw levels).
...
Dc <- x[c(1,16,22,27,38,43,49,64,66,79,85,92,101,108,114,127,136,137,147,158,163,174,184,185,199,202,212,221,228,237,247,250),]
...
Dc_I <- y[c(1,16,22,27,38,43,49,64,66,79,85,92,101,108,114,127,136,137,147,158,163,174,184,185,199,202,212,221,228,237,247,250),]


ExRow <- function(x, y, j, p){
  s = c(0, 0.125, 0.250, 1.000)
  for (i in 1:16){
