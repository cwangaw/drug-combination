...
# Original source file: Design_16_1.R
# Purpose: Search for a 16-point space-filling design via permutation-based centered L2-discrepancy minimization (raw levels).
...
Dc_I <- y[c(1,22,43,64,71,84,109,122,140,159,162,181,206,217,232,243),]
